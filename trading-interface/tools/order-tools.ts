...
const limitOrderParamsSchema = z.object({
  ...
  fromToken: z
    .string()
    .describe('Token address or symbol you are spending (e.g. "wPOKT", "USDC", "USDT" or any other symbol)'),
  toToken: z
    .string()
    .describe('Token address or symbol you are receiving (e.g. "wPOKT", "USDC", "USDT" or any other symbol)'),
